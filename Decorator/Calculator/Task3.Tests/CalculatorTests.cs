...
namespace Calculator.Task3.Tests
{
    [TestClass]
    public class CalculatorTests
    {
        ...
        public void Should_calculate_insurance_payment_logging()
        {
            ...
            var calculator = CreateLoggingCalculator();
        ...
        public void Should_round_insurance_payment()
        {
            ...
            var calculator = CreateRoundingCalculator();
        ...
        {
            return new CalculatorFactory(currencyServiceMock.Object, tripRepositoryMock.Object, loggerMock.Object).CreateCalculator();
        }

        private ICalculator CreateCachedCalculator()
        {
            return new CalculatorFactory(currencyServiceMock.Object, tripRepositoryMock.Object, loggerMock.Object).CreateCachedCalculator();
        }

        private ICalculator CreateLoggingCalculator()
        {
            return new CalculatorFactory(currencyServiceMock.Object, tripRepositoryMock.Object, loggerMock.Object).CreateLoggingCalculator();
        }

        private ICalculator CreateRoundingCalculator()
        {
            return new CalculatorFactory(currencyServiceMock.Object, tripRepositoryMock.Object, loggerMock.Object).CreateRoundingCalculator();
        }
    }
}
